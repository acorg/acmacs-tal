# Time-stamp: <2019-10-14 18:33:48 eu>
...
{"N": "nodes", "select": {"cumulative >=": 0.01}, "apply": "hide"} -- see [[Select Nodes][Select Nodes]]
...
{"N": "report-selected", "select": <[[Select Nodes][Select Nodes]]>}
