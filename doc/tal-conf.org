# Time-stamp: <2020-05-13 09:58:16 eu>
...
#+BEGIN_SRC json
  {"N": "tree", "id": "<id>", "color-by": <[[Color by][color-by]]>, "width-to-height-ratio": 0.7, "debug-outline": <[[Debug outline][debug-outline]]>,
   "legend": { "?type": "world-map|color-by-pos", # type inferred from "color-by"
...
"color-by": {"N": "pos", "pos": 192, "colors": ["red", "green", "blue"]} -- acmacs::color::distinct are used if absent or too few given, X is always black
